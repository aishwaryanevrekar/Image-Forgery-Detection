...
class Test_window(QWidget):
    def __init__(self, parent = None , model_path = "ELA_Model.h5" ):
        super().__init__()
    ...
    def init_window(self):
        ...
        self.line_edit.setFont(QtGui.QFont("Sanserif", 10))
        self.line_edit.setGeometry(QRect(160, 55, 365, 30))
        self.line_edit.setPlaceholderText("image Name here!")

        #Button
        self.button = QPushButton("Browse", self)
        self.button.setGeometry(QRect(540, 54, 90, 30))
        ...
        self.button.setIconSize(QtCore.QSize(18, 18))  # to change icon Size
        self.button.clicked.connect(self.getfiles)

        #Button
        self.button = QPushButton("Test", self)
        self.button.setGeometry(QRect(270, 450, 90, 30))
        ...
        self.button.setGeometry(QRect(180, 450, 90, 30))
        self.button.setToolTip("<h5>test image either Forged or Not Forged!<h5>")  # Notice using h2 tags From Html
        ...
        self.button.setGeometry(QRect(360, 450, 90, 30))
        ...
        self.combo.setGeometry(QRect(80, 15,460 , 30))
        ...
        topleft.setGeometry(QRect(10, 140,300 , 300))
        ...
        topleft = QFrame(self)
        topleft.setFrameShape(QFrame.StyledPanel)
        topleft.setGeometry(QRect(350, 140,300 , 300))
    ...
    def getfiles(self):
        ...
        if self.file_path != "":
            ...
            self.label2.setFont(QtGui.QFont("Sanserif", 18))
    ...
    def on_click(self):
        if self.file_path == "":
            ...
            if str(self.combo.currentText()) == "Error Level Analysis":
                ...
                model = ".\\sys_models\\VGG16_Model.h5"
                self.myThread = Thread()
